...
async def get_books(db: Session, status=None, author=None, sort_by=None, limit=10, offset=0):
    return await book_repository.get_books(db, status, author, sort_by, limit, offset)
